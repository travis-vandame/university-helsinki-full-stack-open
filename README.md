...
|:---:|---|---|:---:|
| [`part0/`](part0/) | Fundamentals of Web Apps (HTTP, forms, basic SPA concepts) | Note App Traditional ( [`Flow`](https://github.com/travis-vandame/university-helsinki-full-stack-open/blob/main/part0/0.4-new-note-traditional-flow.md) )<br />SPA Note Loading ( [`Flow`](https://github.com/travis-vandame/university-helsinki-full-stack-open/blob/main/part0/0.5-spa-loading-flow.md) )<br />SPA New Note ( [`Flow`](https://github.com/travis-vandame/university-helsinki-full-stack-open/blob/main/part0/0.5-spa-new-note-flow.md) ) | ✔️ |
